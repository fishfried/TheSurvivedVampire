...
func _ready() -> void:
	...
	arena_time_manager.arena_difficulty_increased.connect(on_areana_difficulty_increased)
...
func on_areana_difficulty_increased(arena_difficulty:int):
